...
### 1. 인공지능 관점에서의 게임
게임을 인공지능의 성능을 평가하는 **테스트베드**로 활용하는 관점이다.
...
**과거**: 컴퓨터 사양 한계로 콘텐츠를 줄이기 위해 사용했다
**현재**: 방대한 스케일의 게임에서 무한한 콘텐츠를 생성한다
...
**미래 비전:**
게임 AI는 단순히 게임을 잘하는 것을 넘어서, 사람과 함께 즐길 수 있는 파트너로 발전해 나갈 것으로 전망된다.
